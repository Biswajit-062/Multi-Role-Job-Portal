...
export const getAppliedJobs = async (req, res) => {
  try {
    ...
    const application = await Application.find({ applicant: userId }) 
      ...
      .sort({ createdAt: -1 }) // Sorting applications by creation date
    ...
    return res.status(200).json({ applications: application, success: true }); // Returning the applications found
